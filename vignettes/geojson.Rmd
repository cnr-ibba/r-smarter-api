...
```{r}
#| fig.alt: >
#|    Map showing sheep samples from the Hapmap dataset in Italy
#|    plotted over a world map using ggplot2
...
```{r}
#| fig.alt: >
#|    Interactive map showing clustered markers of sheep samples from the
#|    Hapmap dataset in Italy"
leaflet::leaflet(
  data = hapmap_data,

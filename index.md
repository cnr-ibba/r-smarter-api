...
> [CONTRIBUTING.md](https://cnr-ibba.github.io/r-smarter-api/CONTRIBUTING.md)
> guide to set up your development environment with all the required
> dependencies to build and test the package with vignettes.
...
optional and needs to be specified as a
[`list()`](https://rdrr.io/r/base/list.html) object to filter your query
to specific data. For example, if you need all foreground genotype
...
[LICENSE](https://cnr-ibba.github.io/r-smarter-api/LICENSE.md) file for
details.
